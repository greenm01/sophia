...
use sophia_protocol::{
    ...
    ResizeSyncCapability, SeatId, Size, SurfaceId, SurfaceSnapshot, Transform,
    XLIBRE_ROUTED_INPUT_EXTENSION_NAME, XLIBRE_ROUTED_INPUT_ROUTE_EVENT_LENGTH,
    XLIBRE_ROUTED_INPUT_ROUTE_EVENT_OPCODE, XLibreRoutedInputDecision, XLibreRoutedInputOutcome,
    XLibreRoutedInputRequest, XLibreRoutedInputWireRequest, XWindowId, XWindowMirror,
};
