...
- [ ] Wire submitted primary-plane scanout ownership to the native page-flip
  reader so the opt-in atomic hardware smoke can prove page-flip evidence
  before retiring framebuffer resources.
