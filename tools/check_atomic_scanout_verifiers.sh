...
expect_pass tools/verify_xlibre_compat_latency_evidence.sh xlibre_compat_latency_pass.log
expect_fail tools/verify_xlibre_compat_latency_evidence.sh xlibre_compat_latency_slow.log
expect_fail tools/verify_xlibre_compat_latency_evidence.sh xlibre_compat_latency_no_patch.log
expect_pass tools/verify_xlibre_kitty_latency_evidence.sh xlibre_kitty_latency_pass.log
expect_fail tools/verify_xlibre_kitty_latency_evidence.sh xlibre_kitty_latency_degraded.log
expect_fail tools/verify_xlibre_kitty_latency_evidence.sh xlibre_kitty_latency_oversized.log
expect_fail tools/verify_xlibre_kitty_latency_evidence.sh xlibre_kitty_latency_slow.log
expect_fail tools/verify_xlibre_kitty_latency_evidence.sh xlibre_kitty_latency_render_stall.log
expect_fail tools/verify_xlibre_kitty_latency_evidence.sh xlibre_kitty_latency_resource_churn.log
