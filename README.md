...
300-frame diagnostic pass, but the normal release 300-frame lifetime proof still
has timing-sensitive heap corruption. DMA-BUF stays blocked before Kitty
promotion until that normal proof passes. The installed launcher
